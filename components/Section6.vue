<template>
  <div
    class="pt-[6rem] bg-[url('assets/images/section-6-bg.png')] bg-cover bg-no-repeat bg-center"
  >
    <div class="max-w-[1350px] m-auto">
      <div class="max-w-[650px] m-auto">
        ...
        <p class="text-center text-[16px] text-[#DBDBDB]">
          Be part of TOKEN2049 for insights, networking, and<br />the latest in
          blockchain innovation.
        </p>
      </div>
    </div>
    <div
      class="max-w-[1000px] m-auto rounded-[20px] bg-gradient-to-br from-[#ffffff46] via-[#00214a00] to-[#ffffff46] p-[1.5px]"
    >
      <div
